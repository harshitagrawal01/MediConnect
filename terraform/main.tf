...
resource "aws_iam_role" "eks_node_role" {
  name = "mediconnect-eks-node-role"
...
resource "aws_eks_node_group" "mediconnect_nodes" {
  cluster_name    = aws_eks_cluster.mediconnect_cluster.name
  node_group_name = "mediconnect-node-group"

...
const VideoCall = () => {
  ...
  const joinCall = async () => {
    try {
      ...
      // ✅ Handle already-present users (patient joined before doctor)
  ...
  return (
    <div style={{
      ...
      fontFamily: "'DM Sans', sans-serif", padding: '20px', overflow: 'hidden'
    }}>
      <div style={{
      ...
      <div style={{ display: isJoined ? 'none' : 'block', textAlign: 'center', zIndex: 1, maxWidth: '420px', width: '100%' }}>
          <div style={{
            ...
            margin: '0 auto 28px', boxShadow: '0 0 40px rgba(20,184,166,0.4)', animation: 'pulse 2s infinite'
          }}>
          ...
          <h1 style={{ color: '#f1f5f9', fontSize: '28px', fontWeight: '700', marginBottom: '8px', letterSpacing: '-0.5px' }}>MediConnect</h1>
          ...
          <button onClick={joinCall} disabled={!agoraToken} style={{
            width: '100%', padding: '16px',
            background: agoraToken ? 'linear-gradient(135deg, #14b8a6, #0ea5e9)' : 'rgba(255,255,255,0.06)',
            border: 'none', borderRadius: '14px', color: agoraToken ? 'white' : '#475569',
            fontSize: '16px', fontWeight: '600', cursor: agoraToken ? 'pointer' : 'not-allowed',
            ...
            {agoraToken ? (
              ...
              <>
                <div style={{ width: '16px', height: '16px', border: '2px solid #475569', borderTopColor: '#94a3b8', borderRadius: '50%', animation: 'spin 1s linear infinite' }} />
                Preparing session...
              </>
            )}
          </button>
      ...
      <div style={{ display: isJoined ? 'block' : 'none', width: '100%', maxWidth: '1000px', zIndex: 1 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px', padding: '0 4px' }}>
            ...
            <div style={{
              ...
              borderRadius: '20px', padding: '6px 14px', color: '#e2e8f0', fontSize: '14px',
          ...
          <div style={{
            ...
            {!remoteUser && (
              <div style={{
                ...
                <div style={{ width: '80px', height: '80px', background: 'rgba(255,255,255,0.06)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <div style={{ display: 'flex', gap: '6px' }}>
                  {[0, 1, 2].map(i => (
                    <div key={i} style={{ width: '8px', height: '8px', background: '#14b8a6', borderRadius: '50%', animation: `bounce 1.2s ${i * 0.2}s infinite` }} />
                  ))}
                </div>
              </div>
            )}
            ...
            <div style={{
              ...
              overflow: 'hidden', border: '2px solid rgba(20,184,166,0.4)', boxShadow: '0 8px 32px rgba(0,0,0,0.5)'
            }}>
              ...
              <div style={{ position: 'absolute', bottom: '6px', left: '8px', color: 'rgba(255,255,255,0.7)', fontSize: '11px', fontWeight: '500' }}>You</div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '16px' }}>
            <button onClick={toggleMute} style={{
              ...
              transition: 'all 0.2s ease', boxShadow: isMuted ? '0 4px 20px rgba(239,68,68,0.4)' : '0 4px 20px rgba(0,0,0,0.3)'
            }}>
              {isMuted ? (
            ...
            <button onClick={leaveCall} style={{
              ...
              cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center',
              boxShadow: '0 8px 30px rgba(239,68,68,0.5)', transition: 'all 0.2s ease', transform: 'scale(1.05)'
            }}>
            ...
            <button onClick={toggleCamera} style={{
              ...
              cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center',
              transition: 'all 0.2s ease', boxShadow: isCameraOff ? '0 4px 20px rgba(239,68,68,0.4)' : '0 4px 20px rgba(0,0,0,0.3)'
            }}>
              <svg width="22" height="22" fill="none" stroke="white" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.069A1 1 0 0121 8.82v6.36a1 1 0 01-1.447.894L15 14M3 8a2 2 0 012-2h8a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8z" />

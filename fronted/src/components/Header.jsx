    ...
    <div className='flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20'>
      ...
      <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
        ...
        <div className='flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light'>
          <img className='w-28' src={assets.group_profiles2} alt="" />
          <p>Find trusted doctors, book appointments instantly, and take charge of your health — all in one place.</p>
        </div>
      ...
      <div className='md:w-1/2 relative flex items-end justify-center md:overflow-hidden mt-6 md:mt-0'>
        ...
        <img
          ...
          style={{
            ...
            maskImage: 'linear-gradient(to right, transparent 0%, black 25%, black 70%, transparent 100%)',
          }}

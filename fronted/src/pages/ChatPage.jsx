...
const S = {
  ...
  avatar: {
    ...
    fontWeight: "700", fontSize: "0.95rem", color: "#0d6e6e",
    border: "2px solid #d4e8e8", flexShrink: 0,
  },
  topbarName: { fontSize: "0.95rem", fontWeight: "600", color: "#1a2a2a", margin: 0 },
  onlineRow: {
    display: "flex", alignItems: "center", gap: "5px",
    fontSize: "0.75rem", color: "#2eab7a", fontWeight: "500", marginTop: "2px",
  },
  ...
  dateSep: {
    textAlign: "center", fontSize: "0.7rem", color: "#9ab8b8",
  ...
  typingBubble: {
    ...
    padding: "11px 16px", display: "flex", gap: "4px",
...
const TypingDot = ({ delay }) => (
  <div style={{
    ...
    background: "#9ab8b8", animation: `bounce 1.2s ${delay}s infinite`,
  }} />
);
  ...
  return (
    <>
      <style>{`
        ...
        .chat-input::placeholder { color: #9ab8b8; }
        .send-btn-hover:hover { background: #1a9090!important; transform: scale(1.07); }
        .attach-btn:hover { background: #e6f4f4!important; border-radius: 50%; }
      `}</style>
        ...
        <div style={S.pageWrap}>
          <div style={S.card}>
            ...
            <div style={S.topbar}>
              ...
              <div>
                <p style={S.topbarName}>Your Doctor</p>
                <div style={{ ...S.onlineRow, color: online.doctor ? "#2eab7a" : "#aaa" }}>
                  <span style={{ ...S.onlineDot, background: online.doctor ? "#2eab7a" : "#ccc" }} />
                  {online.doctor ? "Online" : "Offline"}
                </div>
              </div>
            </div>
            ...
            <div style={S.messagesArea}>
              ...
              {isTyping && (
                <div style={S.typingRow}>
                  <div style={S.msgInit(false)}>Dr</div>
            ...
            <div style={S.inputBar}>
              ...
              <button className="send-btn-hover" style={S.sendBtn} onClick={sendMessage}>
